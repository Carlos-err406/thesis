...
\addbibresource{bibliography/bibliography.3.bib}
\usepackage{parskip}
...
\include{sections/authorship_declaration}
\newpage

% TUTORS OPINION
\includepdf[pages=-]{../docs/tutors_opinion.pdf}
% \include{sections/tutors_opinion}
% \newpage

% COMPANY SATISFACTION LETTER
\include{sections/company_satisfaction}
\newpage
